...
export default class AddPlaylist extends Component {
  ...
  onLoadingClick2(e) {
    ...
    var req = new Request(
      'http://localhost:4000/playlist/api/addUserPlaylist',
      {
        method: 'POST',
        ...
        .then(function (data) {
          if (response.status === 401) this.showError(data.message);
            ...
            data.message.forEach((row) => {
              ...
              search_song_list.push({
                name: temp_collection.name,
          ...
          <div className="add-card">
            ...
            <div className="details-container">
              ...
              <div className="list-container">
                <div className="p-field-radiobutton">
                  <RadioButton
                    ...
                    checked={this.state.genre === 'bluesMusic'}
                  />
                ...
                <div className="p-field-radiobutton">
                  <RadioButton
                    ...
                    value="rockMusic"
                    onChange={(e) => this.setState({ genre: e.value })}
                    checked={this.state.genre === 'rockMusic'}
                  />
                ...
                <div className="p-field-radiobutton">
                  <RadioButton
                    inputId="city3"
                    name="city"
                    value="rocknrollMusic"
                    onChange={(e) => this.setState({ genre: e.value })}
                    checked={this.state.genre === 'rocknrollMusic'}
                  />
                ...
                <div className="p-field-radiobutton">
                  <RadioButton
                    ...
                    value="hiphopMusic"
                    onChange={(e) => this.setState({ genre: e.value })}
                    checked={this.state.genre === 'hiphopMusic'}
                  />
              ...
              <Button
                ...
                onClick={(e) => this.onLoadingClick2(e)}
              />
            </div>
            <div className="playlist-search-card">
              <div>
                <ListBox
                  className="songlistbox"
                  value={this.state.selecedlistvalue}
                  options={this.state.songsListfromApi}
                  onChange={(e) => this.setState({ selecedlistvalue: e.value })}
                  optionLabel="name"
                  style={{ width: '29rem' }}
                />
                <Button
                  label="Add Song"
                  onClick={(e) => this.addSongsToList(e)}
                />
              </div>
            </div>
          </div>
